    ...
    <>
      ...
      <div className="relative">
        <button
          ...
          className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-[8.5px] font-bold transition-all shadow-xs border ${
            isConnected
        ...
        >
          ...
          {connectedPeers.length > 0 && (
            <span className="px-2 py-0.5 rounded-full bg-emerald-200/60 dark:bg-emerald-800/60 text-[7.5px] font-mono">
